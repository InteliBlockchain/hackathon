...
export const Modal = ({ setModal }: { setModal: React.Dispatch<React.SetStateAction<boolean>> }) => {
    useEffect(() => {
    ...
    const resendConfirmation = async () => {
        ...
        try {
            ...
            toast.error(
                'Ocorreu um erro e o email não pôde ser enviado para ' +
                    watch('email') +
    ...
    return (
        <div className="absolute mx-auto bg-[rgba(0,0,0,0.25)] flex z-10 h-full w-full" id="background">
            <div
                className="w-11/12 md:w-1/2 lg:w-1/4 h-fit my-auto mx-auto flex flex-col bg-[#2e2e2e] py-8 rounded-xl"
                id="sidebar">
                <div className="flex items-center justify-center mb-4 px-4">
                    ...
                    <p className="text-xl font-medium md:mx-auto">Quase lá...</p>
                </div>

                <form
                    className="w-full mt-4 flex flex-col justify-center items-center px-4"
                    onSubmit={handleSubmit(onSubmit)}>
                    <div className="w-full">
                        <p className="text-lg font-medium">E-mail</p>
                        <input
                            className="bg-[rgba(0,0,0,0.25)] w-full px-4 py-2 rounded-lg text-md"
                    ...
                    <p className="my-4 text-md text-[#7D7D7D] text-center">
                    ...
                    {!emailSent && (
                        <button
                            ...
                            } font-semibold text-lg rounded-lg my-2 px-8 w-3/5 py-4 text-[#f1f1f1] shadow-lg}`}
                            type={'submit'}
                            disabled={loading}>
