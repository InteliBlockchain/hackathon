...
//            }
    ...
    return (
        <div className="absolute mx-auto bg-[rgba(0,0,0,0.25)] flex z-10 h-full w-full" id="background">
            <div className="w-4/5 md:w-3/5 lg:w-2/5 h-fit my-auto mx-auto flex flex-col bg-[#2e2e2e] px-4 py-8 rounded-xl" id="sidebar">
                <div className="flex items-center justify-center mb-4">
                    <button className="absolute left-20" onClick={() => setModal(false)}>
                ...
                <div className="w-full mt-4 flex flex-col justify-center items-center">
                    ...
                    <button className="font-semibold text-xl bg-[#4863F7] rounded-lg my-2 px-8 w-3/5 py-4 text-[#f1f1f1] shadow-lg" onClick={() => alert("Indisponível! O que está tentando fazer?")}>
                        Enviar
                    </button>
                </div>
            </div>
