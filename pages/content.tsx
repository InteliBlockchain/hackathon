	...
	return (
		<Layout>
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex flex-col md:grid md:grid-cols-2 gap-2 items-center content-center justify-items-center justify-center md:bg-black bg-center h-auto w-full md:w-full mx-auto">
					<EducacionalCard
